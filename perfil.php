...
$sql = "SELECT * FROM `stacks_player` WHERE `user` = '$user'";
        ...
        <form action="buscador_func.php" method="POST">
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        <input name="user" id="user" type="text" class="form-control" placeholder='Buscar Usuario'
                                            onfocus="this.placeholder = ''"
                                            onblur="this.placeholder = 'Buscar Usuario'">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        ...
                        echo '
                        <div style="padding: 10px;background-color: white;margin: 10px;border-radius: 5px;" class="single_client_logo">
